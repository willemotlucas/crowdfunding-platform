...
<title>Confirmation de suppression du financement</title>
...
<body>
	...
	<div class="container">
		<div class="row">
		   <h1 class="page-header">Suppression du financement</h1>
		</div>
		<div class="page-header">
			<h3> Vous avez bien supprimé le financement ayant l'ID <jsp:getProperty name="makeFundBean" property="id" /> avec les caractéristiques suivantes :</h3>
