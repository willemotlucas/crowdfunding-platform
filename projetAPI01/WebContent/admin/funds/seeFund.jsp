...
<title>Visualisation du financement</title>
...
<body>
	...
	<div class="container">
		<div class="row">
		   <h1 class="page-header">Visualisation d'un financement</h1>
		</div>
		<div class="page-header">
			<h3> Voici le financement ayant l'id : <jsp:getProperty name="makeFundBean" property="id" /></h3>
		</div>
	 	<div class="row">
