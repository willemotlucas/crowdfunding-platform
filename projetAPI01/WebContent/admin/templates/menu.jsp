  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href=""><i class="fa fa-commenting"></i>&nbsp;&nbsp;Discussions</a></li>
        <li><a href=""><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Redactions</a></li>
        <li><a href=""><i class="fa fa-thumbs-o-up"></i>&nbsp;&nbsp;Evaluations</a></li>
        <li><a href=""><i class="fa fa-usd"></i>&nbsp;&nbsp;Financements</a></li>
      </ul>
