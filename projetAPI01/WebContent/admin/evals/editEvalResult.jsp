...
<title>Confirmation de modification de l'evaluation</title>
...
<body>
	...
	<div class="container">
		<div class="row">
		   <h1 class="page-header">Modification de l'evaluation</h1>
		</div>
		<div class="page-header">
			<h3> Vous avez bien modifié l'evaluation ayant l'id : <jsp:getProperty name="evalScoreBean" property="id" /></h3>
		</div>
	 	<div class="row">
