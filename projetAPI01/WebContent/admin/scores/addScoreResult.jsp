...
<title>Confirmation de creation du score</title>
...
<body>
	...
	<div class="container">
		<div class="row">
		   <h1 class="page-header">Ajout d'un score</h1>
		</div>
		<div class="page-header">
			<h3> Vous avez bien ajouté le score ayant l'id : <jsp:getProperty name="scoreBean" property="id" /></h3>
		</div>
	 	<div class="row">
